...
public class Frm3 extends Fragment
{
	...
	{
		View v=inflater.inflate(R.layout.frm3,null,true);
	...
	public void getData()
	{
		...
		Cursor c=db.rawQuery("select * from mlist3 ORDER BY date DESC",null);
		while(c.moveToNext())
		{
	...
	private class Task extends ArrayAdapter
	{
		...
		{
			super(ctx,R.layout.contactlist3,name0);
			this.name0=name0;
			this.num0=num0;
		}
		@Override
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			View v=lv.inflate(R.layout.contactlist3,null,true);
